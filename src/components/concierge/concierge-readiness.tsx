...
export function ConciergeReadiness({ onReady, onNotReady }: ConciergeReadinessProps) {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 text-center">
      ...
      <h2 className="text-2xl font-bold text-brand-800 sm:text-3xl">
        Are you ready to commit to this reset?
      </h2>

      <div className="mx-auto mt-6 max-w-xl rounded-xl bg-brand-50 px-6 py-5 text-left text-sm leading-relaxed text-warm-800">
      ...
      <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
        ...
        <Button
          ...
          className="w-full border-2 border-brand-700 px-8 py-3 text-base text-brand-800 hover:bg-brand-50:bg-dark-700 sm:w-auto"
        >
          I am unsure
        </Button>
        <Button
          variant="outline"
          onClick={onNotReady}
          className="w-full border-2 border-warm-400 px-8 py-3 text-base text-warm-700 hover:bg-warm-100:bg-dark-700 sm:w-auto"
        >
          No, not yet
        </Button>
      </div>
        ...
        {showUnsurePopup && (
          ...
          >
            <motion.div
              ...
              className="max-w-lg rounded-2xl bg-white p-6 shadow-xl sm:p-8"
            >
              <h3 id="unsure-heading" className="text-lg font-bold text-brand-800">
                What does &ldquo;ready to commit&rdquo; actually mean?
              </h3>
              <p className="mt-4 text-sm leading-relaxed text-warm-800">
              ...
              <p className="mt-3 text-sm leading-relaxed text-warm-800">
